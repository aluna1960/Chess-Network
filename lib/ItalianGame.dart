    ...
    return Scaffold(
        ...
        body:Container(
          ...
          child: Column(
            children: [
              SizedBox(height: 70),
              Text('Italian Game', style: GoogleFonts.raleway(fontSize: 30, fontWeight:  FontWeight.w700, color: Colors.white),),
              SizedBox(height: 40),
              Image.asset('assets/images/ItalianGameG.gif',height:300,width: 300,),
              Text(
                '1.e4 e5 2.Nf3 Nc6 3.Bc4',textAlign: TextAlign.center,style: GoogleFonts.droidSerif(fontSize: 25, color: Colors.white),
              ),
              SizedBox(height:40),
              Card(
                elevation: 0,
